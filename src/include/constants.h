...
#if MAX_PLAYERS > 4
#define PLAYERCOUNT()       ((g_Vars.players[0] ? 1 : 0) + (g_Vars.players[1] ? 1 : 0) + (g_Vars.players[2] ? 1 : 0) + (g_Vars.players[3] ? 1 : 0) + (g_Vars.players[4] ? 1 : 0) + (g_Vars.players[5] ? 1 : 0) + (g_Vars.players[6] ? 1 : 0) + (g_Vars.players[7] ? 1 : 0))
#elif MAX_PLAYERS == 4
...
// CHEAT_PP9I..CHEAT_RCP45 (34..41) removed 2026-04-26 with the
// Goldfinger 64 weapon cull; CHEAT_DUALWIELDALLGUNS shifts down 8.
#define CHEAT_DUALWIELDALLGUNS       34
...
#define MODELNODETYPE_TYPE19       0x19
...
// add all classic weapons to multiplayer and allow combat knife in JPN and add IR Scanner and Night Vision
...
// 8 Goldfinger 64 imports (PP9I..RCP45) removed 2026-04-26.
...
#define PROJECTILEFLAG_HOMING      0x00020000 /* PC (B-914): graph IR has_homing; steered in projectileTick */
...
#define STAGE_EXTRA24 0x59 // Rogue
...
/**
 * Stage classification macros.
 *
 * The original codebase used `stagenum >= STAGE_TITLE` as shorthand for
 * "is this a system/menu stage" (title, pak menu, credits, 4MB menu).
 * That assumption breaks when gameplay stages are added above STAGE_TITLE
 * (e.g. EXTRA25=0x5e, EXTRA26=0x5f from AllInOneMods).
 *
 * These macros replace every such range check with an explicit test against
...
enum weaponnum {
	...
	// 8 Goldfinger 64 imports (PP9I, CC13, KL01313, KF7SPECIAL, ZZT,
	// DMC, AR53, RCP45) removed 2026-04-26. All later slots shift down
	// by 8 -- WEAPON_PSYCHOSISGUN was 0x2c, now 0x24, etc.
	/*0x24*/ WEAPON_PSYCHOSISGUN,
	/*0x25*/ WEAPON_NIGHTVISION,
	/*0x26*/ WEAPON_EYESPY,
	/*0x27*/ WEAPON_XRAYSCANNER,
	/*0x28*/ WEAPON_IRSCANNER,
	/*0x29*/ WEAPON_CLOAKINGDEVICE,
	/*0x2a*/ WEAPON_HORIZONSCANNER,
	/*0x2b*/ WEAPON_TESTER,
	/*0x2c*/ WEAPON_ROCKETLAUNCHER_34,
	/*0x2d*/ WEAPON_ECMMINE,
	/*0x2e*/ WEAPON_DATAUPLINK,
	/*0x2f*/ WEAPON_RTRACKER,
	/*0x30*/ WEAPON_PRESIDENTSCANNER,
	/*0x31*/ WEAPON_DOORDECODER,
	/*0x32*/ WEAPON_AUTOSURGEON,
	/*0x33*/ WEAPON_EXPLOSIVES,
	/*0x34*/ WEAPON_SKEDARBOMB,
	/*0x35*/ WEAPON_COMMSRIDER,
	/*0x36*/ WEAPON_TRACERBUG,
	/*0x37*/ WEAPON_TARGETAMPLIFIER,
	/*0x38*/ WEAPON_DISGUISE40,
	/*0x39*/ WEAPON_DISGUISE41,
	/*0x3a*/ WEAPON_FLIGHTPLANS,
	/*0x3b*/ WEAPON_RESEARCHTAPE,
	/*0x3c*/ WEAPON_BACKUPDISK,
	/*0x3d*/ WEAPON_KEYCARD45,
	/*0x3e*/ WEAPON_KEYCARD46,
	/*0x3f*/ WEAPON_KEYCARD47,
	/*0x40*/ WEAPON_KEYCARD48,
	/*0x41*/ WEAPON_KEYCARD49,
	/*0x42*/ WEAPON_KEYCARD4A,
	/*0x43*/ WEAPON_KEYCARD4B,
	/*0x44*/ WEAPON_KEYCARD4C,
	/*0x45*/ WEAPON_SUITCASE,
	/*0x46*/ WEAPON_BRIEFCASE,
#if VERSION >= VERSION_NTSC_1_0
	/*0x47*/ WEAPON_SHIELDTECHITEM,
#endif
	/*0x48*/ WEAPON_NECKLACE,
	/*0x49*/ WEAPON_HAMMER,
	/*0x4a*/ WEAPON_SCREWDRIVER,
	/*0x4b*/ WEAPON_ROCKET,
	/*0x4c*/ WEAPON_HOMINGROCKET,
	/*0x4d*/ WEAPON_GRENADEROUND,
	/*0x4e*/ WEAPON_BOLT,
	/*0x4f*/ WEAPON_BRIEFCASE2,
	/*0x50*/ WEAPON_SKROCKET,
	/*0x51*/ WEAPON_CHOPPERGUN,
	/*0x52*/ WEAPON_WATCHLASER,
	/*0x53*/ WEAPON_MPSHIELD,
...
//
// 2026-04-26: moved from WEAPON_RCP45 to WEAPON_COMBATBOOST after the
// 8 Goldfinger 64 imports were culled. WEAPON_COMBATBOOST is the new
// last slot in the "real weapons + tactical items" run before the
// device/scanner/keycard slots.
#define WEAPON_MAX_DROPPABLE WEAPON_COMBATBOOST
...
#define HEAD_RANDOM_GENDER    1000
