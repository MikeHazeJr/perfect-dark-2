...
u8 func0404_spawn_enemies[] = {
	...
	try_spawn_chr_at_chr(BODY_DDSHOCK, HEAD_DDSHOCK, 0x06, AILIST_INIT_ENEMY, SPAWNFLAG_ALLOWONSCREEN, /*goto*/ 0xa2)
	goto_next(0x01)
	label(0xa2)
	yield
	subtract_morale(1)
...
u8 func0405_spawn_maians[] = {
	...
	label(0x04)
	if_morale_lt(1, /*goto*/ 0x01)
	try_spawn_chr_at_chr(BODY_ELVIS1, HEAD_ELVIS, 0x07, AILIST_INIT_MAIAN, SPAWNFLAG_ALLOWONSCREEN, /*goto*/ 0xa2)
	goto_next(0x01)
	label(0xa2)
	yield
	subtract_morale(1)
