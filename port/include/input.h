...
enum virtkey {
	...
	/* Keep all old player values and saved names stable. Slots 22-31 remain
	 * legacy button/axis aliases; new captures use precise keys below. */
	VK_JOY_LEGACY_END = VK_JOY_BEGIN + INPUT_MAX_CONTROLLERS * INPUT_MAX_CONTROLLER_BUTTONS,
	VK_JOY_RAW_BUTTON_BEGIN = VK_JOY_LEGACY_END,
	VK_JOY_AXIS_BEGIN = VK_JOY_RAW_BUTTON_BEGIN + INPUT_MAX_CONTROLLERS * 10,
	VK_TOTAL_COUNT = VK_JOY_AXIS_BEGIN + INPUT_MAX_CONTROLLERS * 10,
};
