...
/**
 * Interact-style prompt: "Hold " + [key pill] + verb, horizontally centred.
 * A thick radial ring around the key pill shows `hold_progress` (0..1) toward
 * the hold threshold; full circle track + accent arc.  hold_progress >= 1
 * uses the brighter "ready" colour.
 */
