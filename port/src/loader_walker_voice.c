                      ...
                      const char *file_path)
{
    ...
    char language[16] = "";
    char context[128] = "";
    char subtitle_member[FS_MAXPATH] = "";
    char fallback_locale[16] = "";
    char locale_members[6][FS_MAXPATH] = {{0}};
    ...
    if (loaderWalkerArchiveTextMember(file_path, "voice.ini",
        ...
        loaderWalkerIniPathCopy(voice_ini, voice_ini_len, "voice", "subtitle_file",
                                 ...
                                 fallback_locale, sizeof(fallback_locale));
        {
            ...
            for (s32 i = 0; i < 6; i++) {
                loaderWalkerIniPathCopy(voice_ini, voice_ini_len, "voice",
