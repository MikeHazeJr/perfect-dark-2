    ...
    write_archive("weapons/tri_weapon.pdweapon", [
        ...
        ("behavior/shared-context.json",
         json.dumps({
             ...
             "asset_id": "example:tri_weapon",
             "contexts": [
                 {"name": "owner_player", "scope": "player", "source": "equipped_player",
                  "type": "player_ref", "lifetime": "weapon_instance"},
                 {"name": "owner_team", "scope": "player", "source": "equipped_player_team",
                  "type": "team_ref", "lifetime": "weapon_instance"},
                 {"name": "weapon_instance", "scope": "weapon", "source": "equipped_weapon",
                  "type": "weapon_instance_ref", "lifetime": "weapon_instance"},
                 {"name": "damage_credit_player", "scope": "projectile", "source": "owner_player",
                  "type": "player_ref", "lifetime": "projectile_life"},
             ],
         }, indent=2) + "\n"),
