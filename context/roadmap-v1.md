...
| **Catalog as data provider (M0.1e)** | SA-5d body/head property accessors + SA-5e MP weapon table accessors. 11 game files migrated (body.c, chraction.c, botmgr.c, bot.c, bondgun.c, botinv.c, activemenu.c, challenge.c, mplayer.c, setup.c, player.c). `g_MpWeapons` stub added to server_stubs.c. Deferred: modeldef cache, ammo distribution (priammotype/priammoqty). Commit `b3555576`. | assetcatalog.h, assetcatalog_api.c, 11 game files, server_stubs.c | **DONE S178** |
