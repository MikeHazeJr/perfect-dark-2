...
- **D2c Bot Jump AI.** Not started. Depends on D2b stability (capsule sweep). Bot jump pathing requires AI to reason about jumpable gaps, which the capsule sweep makes accurate but no AI consumer is wired yet.
