...
- **2026-08-08 `.pdeffect` v2 production consumers (T-ASSETS-019/B-1004)**: complete public explosion, spark, and smoke libraries now transactionally override the real 26/27/23 native row tables, including typed SFX resolution and explosion-to-smoke ownership. Exact growable typed dependency enumeration runs before catalog activation for standalone, base, nested weapon, mod, and network-scanned sources; missing, empty, null, malformed, aliased, wrong-node, wrong-type, cyclic, or unavailable dependencies reject without native fallback. The Wave8 receipt passes T019 129/5, effect graph 571/15, the complete 52,416/932 suite, all 27 archive families, and the native-source guard. T-ASSETS-037 now closes nested discovery/preflight omission above 64. T019 remains partial for the generic v1 scheduler and consumers (`T-ASSETS-032/034/035/036`), reverse child invalidation (`T-ASSETS-033`), and live edited-source proof (`V-009`).
