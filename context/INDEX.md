...
| 3 | [session-log.md](session-log.md) | Last sessions (**S281–S313**) |
...
| Range | Location |
|-------|----------|
| **S281–S313** (active, rolling) | [session-log.md](session-log.md) |
...
- After substantive work: update **tasks-current**, **session-log**, **bugs** as needed.
