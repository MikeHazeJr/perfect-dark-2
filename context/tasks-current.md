...
| D3R-11 | ~~**Legacy cleanup**~~ | D3R-5 | **DONE (S45)** ✓ MERGED: `g_ModNum` removed, `modconfig.txt` removed, shadow arrays removed, all modmgr accessors catalog-only. Build test pending (TEMP env issue — run manually). |
