...
| B-14 | **START on controller opens/closes pause immediately** — double-fire or input passthrough | MED | S26 | Likely input consumed by both legacy and ImGui handler in same frame | NEEDS DIAGNOSIS |
...
| B-16 | **Back on controller does nothing** in ImGui pause menu | MED | S26 | ImGui backend may not be mapping gamepad B to navigation back | NEEDS DIAGNOSIS |
